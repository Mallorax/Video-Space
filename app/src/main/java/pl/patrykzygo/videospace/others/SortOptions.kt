...
object SortOptions {
    ...
    //Don't change values as they are tied to options provided by API
    ...
    const val SCORE_AVERAGE_DESC = "vote_average.desc"
    const val SCORE_AVERAGE_ASC = "vote_average.asc"
